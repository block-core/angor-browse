using Angor.Browse.BlockcoreWallet.Exceptions;
...
namespace Angor.Browse.BlockcoreWallet
{
	...
	public class BlockcoreWalletConnector : IAsyncDisposable, IBlockcoreWalletConnector
	{
		...
		{
			return jsRuntime.InvokeAsync<IJSObjectReference>("import", "./_content/Angor.Browse.BlockcoreWallet/blockcoreWallet.js");
		}
